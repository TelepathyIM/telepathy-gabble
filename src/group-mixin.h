...
typedef gboolean (*GabbleGroupMixinAddMemberFunc) (GObject *obj, TpHandle handle, const gchar *message, GError **error);
typedef gboolean (*GabbleGroupMixinRemMemberFunc) (GObject *obj, TpHandle handle, const gchar *message, GError **error);
...
void gabble_group_mixin_init (GObject *obj, glong offset, GabbleHandleRepo *handle_repo, TpHandle self_handle);
...
gboolean gabble_group_mixin_change_members (GObject *obj, const gchar *message, TpIntSet *add, TpIntSet *remove, TpIntSet *local_pending, TpIntSet *remote_pending, TpHandle actor, guint reason);

void gabble_group_mixin_add_handle_owner (GObject *obj, TpHandle local_handle, TpHandle owner_handle);
