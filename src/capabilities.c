...
static const Feature self_advertised_features[] =
{
  ...
  { BUNDLE_OLPC, NS_OLPC_BUDDY_PROPS, 0},
  { BUNDLE_OLPC, NS_OLPC_BUDDY_PROPS "+notify", 0},
  { BUNDLE_OLPC, NS_OLPC_ACTIVITIES, 0},
  { BUNDLE_OLPC, NS_OLPC_ACTIVITIES "+notify", 0},
  { BUNDLE_OLPC, NS_OLPC_CURRENT_ACTIVITY, 0},
  { BUNDLE_OLPC, NS_OLPC_CURRENT_ACTIVITY "+notify", 0},
  { BUNDLE_OLPC, NS_OLPC_ACTIVITY_PROPS, 0},
  { BUNDLE_OLPC, NS_OLPC_ACTIVITY_PROPS "+notify", 0},
