...
static const Feature self_advertised_features[] =
{
  ...
  { BUNDLE_OLPC, NS_OLPC_BUDDY_PROPS "+notify", PRESENCE_CAP_OLPC},
  { BUNDLE_OLPC, NS_OLPC_ACTIVITIES "+notify", PRESENCE_CAP_OLPC},
  { BUNDLE_OLPC, NS_OLPC_CURRENT_ACTIVITY "+notify", PRESENCE_CAP_OLPC},
  { BUNDLE_OLPC, NS_OLPC_ACTIVITY_PROPS "+notify", PRESENCE_CAP_OLPC},
